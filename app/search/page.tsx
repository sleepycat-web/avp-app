...
export default function SearchPage() {
  ...
  const mockResults = [
    {
      id: 1,
      title: "Scholarship Application Form 2024",
      department: "Education",
      type: "PDF",
      date: "Jan 15, 2024",
      relevance: 98,
      snippet:
        "...form for <mark>scholarship</mark> applications for the year <mark>2024</mark>. Students must submit by...",
    },
    {
      id: 2,
      ...
      relevance: 85,
      snippet:
        "...guidelines for <mark>scholarship</mark> eligibility criteria and application process...",
    },
    {
      id: 3,
      title: "Merit Scholarship Program Announcement",
      department: "Education",
      type: "DOCX",
      date: "Feb 5, 2024",
      relevance: 72,
      snippet:
        "...announcing the Merit <mark>Scholarship</mark> Program for <mark>2024</mark> academic year...",
    },
  ];
  ...
  const resultsToDisplay = expandedResultId
    ? mockResults.filter((result) => result.id === expandedResultId)
    : mockResults;
              ...
              <div className="order-1 md:order-2">
                <div className="mb-4 flex items-center justify-between">
                  <h3 className="text-lg font-medium">
                    {expandedResultId === 2 ? 1 : resultsToDisplay.length}{" "}
